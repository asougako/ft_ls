...
c	-c	Use time when file status was last changed for sorting (-t) or long printing (-l).
...
x	-t	Sort by time modified (most recently modified first) before sorting the operands by lexico-
		graphical order.
c	-u	Use time of last access, instead of last modification of the file for sorting (-t) or long
		printing (-l).
c	-U	Use time of file creation, instead of last modification for sorting (-t) or long output (-l).
